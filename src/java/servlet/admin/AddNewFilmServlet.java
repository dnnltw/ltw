...
public class AddNewFilmServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddNewFilmServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddNewFilmServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            System.out.println(formatter.parse(request.getParameter("releaseDate")));
            ...
            if(dao.addFilm(con, film)){
                ...
                session.setAttribute("listFilm", dao.getListFilm(con));
